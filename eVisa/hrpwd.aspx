<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hrpwd.aspx.cs" Inherits="eVisa.WebForm7" %>
...
<body>
    <div class="form-container">
        ...
        <form id="pwd" runat="server">
            ...
            <div class="form-control">
                <asp:Button ID="changepwd" class="sub-btn" runat="server" Text="Change password" OnClick="cpwd_Click" />
            </div>
            <div class="form-control">
